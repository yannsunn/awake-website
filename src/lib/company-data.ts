...
export const COMPANY_DATA = {
  basic: {
    ...
    tagline: '型にはまらない、あなただけのIT戦略',
    description: 'オーバースペックでもなく、機能不足でもない。最適な投資を',
    subMessage: '大手ベンダーの画一的なソリューションでは高すぎる。かといって安価なツールの寄せ集めでは不十分。御社のビジネスに最適化された、オーダーメイドのIT戦略をご提案します。'
  },
  contact: {
    address: {
      postal: '〒207-0013',
