        ...
        <div className="mt-8 p-6 bg-gray-700/50 rounded-xl shadow-lg border-2 border-gray-600">
          ...
          <ul className="space-y-2 text-left max-w-sm mx-auto">
            <li className="flex items-start">
              ...
              <span className={STYLES.text.description.small + " text-gray-200"}>サービスの詳細や料金について</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-400 mr-2">✓</span>
              <span className={STYLES.text.description.small + " text-gray-200"}>現在の課題の相談</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-400 mr-2">✓</span>
              <span className={STYLES.text.description.small + " text-gray-200"}>導入事例のご紹介</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-400 mr-2">✓</span>
              <span className={STYLES.text.description.small + " text-gray-200"}>その他、どんなご質問でもOK</span>
            </li>
          </ul>
        </div>
      </div>
