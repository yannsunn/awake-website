...
export default function HomeHero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden -mt-16 md:-mt-20 pt-16 md:pt-20 z-20 bg-gradient-to-b from-gray-50 to-white">
      {/* 背景動画 - 半透明オーバーレイ */}
        ...
        <div className="text-center">
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <br />
              チャットボット搭載ホームページ制作{' '}
              <span className="whitespace-nowrap">198,000円〜</span>
              <br />
              月額制AI顧問{' '}
              <span className="whitespace-nowrap">33,000円〜</span>
              <br />
              Amazon販売代行{' '}
              <span className="whitespace-nowrap">完全成果報酬</span>
            </motion.p>
