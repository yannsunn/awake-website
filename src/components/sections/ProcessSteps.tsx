          ...
          <ol className="relative space-y-6 sm:space-y-8 lg:space-y-10">
            {steps.map((stepData, index) => (
              <li key={index} className="relative pl-10 sm:pl-12 lg:pl-16">
                <div className="absolute left-0 top-0 flex h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 items-center justify-center rounded-full bg-blue-600 text-xs sm:text-sm lg:text-base font-bold text-white shadow-lg">
                  {stepData.step}
                </div>
