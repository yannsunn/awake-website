          ...
          <div>
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              ...
              <p className="text-sm sm:text-base">
                静岡県清水区で生まれ育ちました。実は幼稚園、小学校、中学校と不登校を経験し、人とのつながりや社会との向き合い方について、苦しみながらも深く考える時間を過ごしました。その経験が、今の「人との縁を大切にする」という経営哲学の土台となっています。
              </p>
              
              <p className="text-sm sm:text-base">
                その後、トヨタ系ディーラーで整備士として働き、物販事業を経て、2020年に株式会社Awakeを設立しました。幼い頃の経験があったからこそ、人とのつながり、縁を大切にすることの重要性を心から理解しています。
              </p>
              
              <p className="text-sm sm:text-base">
                ホームページ制作を始めたきっかけは、多くの企業が高額なホームページを作ったものの、その使い方が分からず、結果的に死蔵させてしまっている現実を目の当たりにしたことでした。それであれば、当社が高品質なホームページを低価格で提供し、浮いたコストを会社の業務効率化やシステム導入など、より生産的な投資に回していただきたい。そんな想いからサービスをスタートしました。
              </p>
              
              <p className="text-sm sm:text-base">
                ホームページは会社の顔であり、大切な投資です。しかし、高額な費用をかけても、その後の運用や活用ができなければ意味がありません。私たちは、お客様のビジネスを理解し、コストパフォーマンスの高いソリューションを提供することで、お客様の限られた経営資源を最大限に活用していただきたいと考えています。
              </p>
