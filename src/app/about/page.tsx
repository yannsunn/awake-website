          ...
          <div className="lg:pl-8">
            <div className="bg-gradient-to-br from-gray-800/95 to-gray-850/95 backdrop-blur-sm rounded-2xl pt-8 pb-6 px-6 sm:pt-10 sm:px-8 text-center border border-purple-500/20 shadow-lg">
              <div className="relative w-64 h-64 mx-auto mb-6">
                ...
                <div className="relative w-64 h-64 rounded-2xl overflow-hidden border-4 border-gradient-to-r from-violet-400 to-purple-400 shadow-2xl ring-4 ring-purple-500/20 ring-offset-4 ring-offset-gray-900">
                  <OptimizedImage
