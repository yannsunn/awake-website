              ...
              <div className="space-y-8">
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 p-6">
                    <dl className="grid grid-cols-1 gap-4">
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <dt className="text-base font-semibold text-gray-900">会社名</dt>
                        <dd className="sm:col-span-2 text-base text-gray-900">{COMPANY_DATA.basic.name}（{COMPANY_DATA.basic.nameEn}）</dd>
                      </div>
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <section>
                  ...
                  <div className="text-base text-gray-900 leading-relaxed space-y-4">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 p-6">
                      <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3">主要サービス料金</h3>
                ...
                <section>
                  ...
                  <div className="text-base text-gray-900 leading-relaxed space-y-4">
                    ...
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mt-6">支払方法</h3>
                    <ul className="list-disc list-inside space-y-2">
                      <li>銀行振込</li>
                      <li>請求書払い（法人のみ）</li>
                    </ul>
                ...
                <section>
                  ...
                  <div className="text-base text-gray-900 leading-relaxed space-y-4">
                    ...
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">例外事項</h3>
                    <ul className="list-disc list-inside space-y-2">
                      <li>弊社の責に帰すべき事由により、契約内容と著しく異なるサービスが提供された場合</li>
                      <li>サービス開始前であり、やむを得ない事情がある場合（キャンセル料が発生する場合があります）</li>
                    </ul>
                    
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mt-6">キャンセル料</h3>
                    <ul className="list-disc list-inside space-y-2">
                ...
                <section>
                  ...
                  <div className="text-base text-gray-900 leading-relaxed space-y-4">
                    ...
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">準拠法・管轄</h3>
                    <p>
                      本契約は日本法に準拠し、契約に関する一切の紛争については東京地方裁判所を専属的合意管轄裁判所とします。
                    </p>

                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">免責事項</h3>
                    <ul className="list-disc list-inside space-y-2">
                ...
                <section>
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 mt-4 p-6">
                    ...
                    <p className="text-base text-gray-900">担当者: {COMPANY_DATA.basic.ceo}</p>
                    <p className="text-base text-gray-900">{COMPANY_DATA.contact.address.postal} {COMPANY_DATA.contact.address.full}</p>
                    <p className="text-base text-gray-900">TEL: {COMPANY_DATA.contact.phone}</p>
                    <p className="text-base text-gray-900">Email: {COMPANY_DATA.contact.email}</p>
