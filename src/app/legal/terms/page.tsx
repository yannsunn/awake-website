          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-8">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">2. 利用登録</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">4. 本サービスの提供の停止等</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">5. 保証の否認および免責事項</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">6. サービス内容の変更等</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">7. 利用規約の変更</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">8. 個人情報の取扱い</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">9. 準拠法・裁判管轄</h2>
                  <p className="text-gray-700 leading-relaxed">
