      ...
      <UltraSection variant="medium">
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-8">
            <section>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">1. 規約の適用</h2>
              <p className="text-base sm:text-lg text-gray-900">
                ...
                <section>
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">2. 利用登録</h2>
                ...
                <section>
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">3. 禁止事項</h2>
                ...
                <section>
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">4. 本サービスの提供の停止等</h2>
                  <p className="text-base sm:text-lg text-gray-900 leading-relaxed">
                    当社は、以下のいずれかの事由があると判断した場合、ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるものとします。
                  </p>
                  <ul className="list-disc list-inside text-base sm:text-lg text-gray-900 leading-relaxed space-y-2 mt-4">
                ...
                <section>
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">5. 保証の否認および免責事項</h2>
                  <p className="text-base sm:text-lg text-gray-900 leading-relaxed">
                ...
                <section>
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">6. サービス内容の変更等</h2>
                  <p className="text-base sm:text-lg text-gray-900 leading-relaxed">
                ...
                <section>
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">7. 利用規約の変更</h2>
                  <p className="text-base sm:text-lg text-gray-900 leading-relaxed">
                ...
                <section>
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">8. 個人情報の取扱い</h2>
                  <p className="text-base sm:text-lg text-gray-900 leading-relaxed">
                ...
                <section>
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">9. 準拠法・裁判管轄</h2>
                  <p className="text-base sm:text-lg text-gray-900 leading-relaxed">
                ...
                <section>
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">10. お問い合わせ</h2>
                  <p className="text-base sm:text-lg text-gray-900 leading-relaxed">
