    ...
    >
      ...
      <ContentSection className="bg-gray-900/95">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className={STYLES.heading.h1.primary + " text-white mb-4"}>利用規約</h1>
          <p className={STYLES.text.description.small + " text-gray-400"}>最終更新日: 2024年1月1日</p>
        </div>
      </ContentSection>
      ...
      <ContentSection className="bg-gray-800/90">
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-8">
            <section>
              <h2 className={STYLES.heading.h2.subsection + " text-white mb-4"}>1. 規約の適用</h2>
              <p className={STYLES.text.body.medium + " text-gray-300"}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")}>2. 利用登録</h2>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")}>3. 禁止事項</h2>
                ...
                <section>
                  ...
                  <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2 mt-4">
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")}>5. 保証の否認および免責事項</h2>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")}>6. サービス内容の変更等</h2>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")}>7. 利用規約の変更</h2>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")}>8. 個人情報の取扱い</h2>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")}>9. 準拠法・裁判管轄</h2>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")}>10. お問い合わせ</h2>
                  <p className="text-gray-300 leading-relaxed">
