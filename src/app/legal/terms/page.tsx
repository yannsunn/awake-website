      ...
      <UltraSection variant="medium">
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-8">
            <section>
              <h2 className={STYLES.heading.h2.subsection + " text-white mb-4"} style={TEXT_SHADOW.body}>1. 規約の適用</h2>
              <p className={STYLES.text.body.medium + " text-gray-200"} style={TEXT_SHADOW.body}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={TEXT_SHADOW.body}>2. 利用登録</h2>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={TEXT_SHADOW.body}>3. 禁止事項</h2>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={TEXT_SHADOW.body}>5. 保証の否認および免責事項</h2>
                  <p className="text-gray-200 leading-relaxed" style={TEXT_SHADOW.body}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={TEXT_SHADOW.body}>6. サービス内容の変更等</h2>
                  <p className="text-gray-200 leading-relaxed" style={TEXT_SHADOW.body}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={TEXT_SHADOW.body}>7. 利用規約の変更</h2>
                  <p className="text-gray-200 leading-relaxed" style={TEXT_SHADOW.body}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={TEXT_SHADOW.body}>8. 個人情報の取扱い</h2>
                  <p className="text-gray-200 leading-relaxed" style={TEXT_SHADOW.body}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={TEXT_SHADOW.body}>9. 準拠法・裁判管轄</h2>
                  <p className="text-gray-200 leading-relaxed" style={TEXT_SHADOW.body}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={TEXT_SHADOW.body}>10. お問い合わせ</h2>
                  <p className="text-gray-200 leading-relaxed" style={TEXT_SHADOW.body}>
