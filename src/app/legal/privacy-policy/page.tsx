...
export default function PrivacyPolicyPage() {
  ...
  return (
    ...
    >
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-12">
              <section className="corp-card">
                <h2 className="corp-heading-3 mb-4">1. 個人情報の定義</h2>
              ...
              <section className="corp-card">
                <h2 className="corp-heading-3 mb-4">2. 個人情報の収集方法</h2>
                <p className="corp-text-body mb-4">
                  当社は、お客様から個人情報を収集する際は、適法かつ公正な手段により、かつお客様の意思に基づいて収集いたします。当社が個人情報を収集する場面は、主に以下の通りです。
                </p>
                <ul className="list-disc list-inside corp-text-body space-y-2 ml-4">
              ...
              <section className="corp-card">
                <h2 className="corp-heading-3 mb-4">3. 収集する個人情報の項目</h2>
                <p className="corp-text-body mb-4">
              ...
              <section className="corp-card">
                <h2 className="corp-heading-3 mb-4">4. 個人情報の利用目的</h2>
                <p className="corp-text-body mb-4">
              ...
              <section className="corp-card">
                <h2 className="corp-heading-3 mb-4">5. 個人情報の第三者提供</h2>
                <p className="corp-text-body mb-4">
              ...
              <section className="corp-card">
                <h2 className="corp-heading-3 mb-4">6. 個人情報の開示・訂正・削除</h2>
                <p className="corp-text-body">
              ...
              <section className="corp-card">
                <h2 className="corp-heading-3 mb-4">7. 個人情報の安全管理</h2>
                <p className="corp-text-body">
              ...
              <section className="corp-card">
                <h2 className="corp-heading-3 mb-4">8. Cookie（クッキー）について</h2>
                <p className="corp-text-body">
              ...
              <section className="corp-card">
                <h2 className="corp-heading-3 mb-4">9. アクセス解析ツールについて</h2>
                <p className="corp-text-body">
              ...
              <section className="corp-card">
                <h2 className="corp-heading-3 mb-4">10. プライバシーポリシーの変更</h2>
                <p className="corp-text-body">
              ...
              <section className="corp-card">
                <h2 className="corp-heading-3 mb-4">11. お問い合わせ</h2>
                <p className="corp-text-body mb-6">
                  本プライバシーポリシーに関するお問い合わせは、下記の連絡先までお願いいたします。
                </p>
                <div className="bg-blue-50 p-6 rounded border border-blue-200">
                  <p className="corp-text-body text-black font-bold mb-3">{COMPANY_DATA.basic.name}</p>
                  <p className="corp-text-body text-black">個人情報保護責任者: {COMPANY_DATA.basic.ceo}</p>
      ...
      {/* Contact CTA */}
      <section className="corp-section" style={{ background: 'var(--corp-bg-secondary)' }}>
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <Link href="/#contact" className="corp-button-primary inline-block">
            お問い合わせ
          </Link>
        </div>
      </section>
