    ...
    >
      ...
      <ContentSection className="bg-gray-900/60">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className={STYLES.heading.h1.primary + " text-white mb-4"} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>プライバシーポリシー</h1>
      ...
      <ContentSection className="bg-gray-800/30">
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-8">
            <section>
              <h2 className={STYLES.heading.h2.subsection + " text-white mb-4"} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>1. 個人情報の定義</h2>
              <p className={STYLES.text.body.medium + " text-gray-200"} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>
            ...
            <section>
              <h2 className={STYLES.heading.h2.subsection + " text-white mb-4"} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>2. 個人情報の収集方法</h2>
              <p className={STYLES.text.body.medium + " text-gray-200"} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>
              ...
              <ul className="list-disc list-inside text-gray-200 leading-relaxed space-y-2" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>3. 収集する個人情報の項目</h2>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>4. 個人情報の利用目的</h2>
                  <p className="text-gray-200 leading-relaxed mb-4" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>5. 個人情報の第三者提供</h2>
                  <p className="text-gray-200 leading-relaxed mb-4" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>6. 個人情報の開示・訂正・削除</h2>
                  <p className="text-gray-200 leading-relaxed" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>7. 個人情報の安全管理</h2>
                  <p className="text-gray-200 leading-relaxed" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>8. Cookie（クッキー）について</h2>
                  <p className="text-gray-200 leading-relaxed" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>9. アクセス解析ツールについて</h2>
                  <p className="text-gray-200 leading-relaxed" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>10. プライバシーポリシーの変更</h2>
                  <p className="text-gray-200 leading-relaxed" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>
                ...
                <section>
                  <h2 className={cn(STYLES.heading.h2.subsection, "text-white mb-4")} style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>11. お問い合わせ</h2>
                  <p className="text-gray-200 leading-relaxed" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>
                  ...
                  <div className="mt-4 p-6 bg-gray-800/80 backdrop-blur-sm border border-gray-700 rounded-lg">
                    ...
                    <p className="text-gray-200" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)' }}>個人情報保護責任者: {COMPANY_DATA.basic.ceo}</p>
