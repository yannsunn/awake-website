        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-sm sm:text-base text-gray-200 leading-relaxed space-y-2">
                ...
                <section>
                  ...
                  <div className="mt-4 p-6 bg-gray-overlay rounded-lg">
                    ...
                    <p className="text-gray-200">個人情報保護責任者: {COMPANY_DATA.basic.ceo}</p>
