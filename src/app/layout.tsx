...
export const metadata: Metadata = {
  ...
  title: "株式会社Awake（アウェイク）| 東京都東大和市のチャットボット搭載ホームページ制作・月額制AI顧問・Amazon代理店",
  description: "東京都東大和市の株式会社Awake（アウェイク）。チャットボット搭載ホームページ制作19.8万円〜、月額制AI顧問・システム導入3.3万円〜、Amazon EC販売代行を適正価格で提供。中小企業のDX推進・業務効率化を支援します。",
  keywords: "株式会社Awake,アウェイク,東大和市,チャットボット搭載ホームページ制作,Webサイト制作,月額制AI顧問,AIシステム導入,Amazon代理店,EC販売代行,中小企業,DX支援,業務効率化,東京",
  openGraph: {
